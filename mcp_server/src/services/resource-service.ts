...
const resourceDefinitions: MCPResource[] = [
  {
    ...
    description:
      "Common WIQL query patterns and examples for Azure DevOps work items. Essential patterns for querying by parent, type, state, and area path.",
  ...
  },
  {
    ...
    description:
      "OData Analytics query examples for metrics and aggregations. Use for counts, velocity, cycle time, and grouping operations.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Patterns for querying and building work item hierarchies. Includes parent-child relationships, recursive queries, and tree building.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "End-to-end workflow examples combining multiple tools. Includes feature decomposition, backlog cleanup, and bulk operations.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Quick decision guide for which tool to use for different tasks. Helps choose between WIQL, OData, context packages, and AI analyzers.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Comprehensive guide to using query handles for bulk operations. Eliminates ID hallucination by ensuring work item IDs come from Azure DevOps, not LLM memory.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "AI-powered bulk enhancement tools for work items. Includes bulk description enhancement, story point estimation, and acceptance criteria generation with complete workflow patterns and safety features.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Query handle patterns for safe analysis workflows. Provides explicit handle-first patterns for common analysis scenarios to prevent ID hallucination with complete workflow examples.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "AI-powered tool discovery for finding the right tools using natural language. Includes confidence scoring, workflow recommendations, and usage examples for discovering MCP server capabilities.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Guide to generating WIQL queries from natural language using AI. Includes examples, patterns, and best practices for query generation.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Individual workload health analysis for burnout prevention and career development. Includes burnout risk assessment, overspecialization detection, and custom intent analysis.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "AI-powered sprint planning tool for optimal work assignment. Includes velocity analysis, capacity assessment, balanced work distribution, and risk mitigation.",
    mimeType: "text/markdown",
  },
  {
    ...
    description:
      "Comprehensive guide to tool limitations, constraints, and restrictions. Covers WIQL vs OData limitations, bulk operations, AI tools, ADO API limits, performance constraints, and common workarounds.",
    mimeType: "text/markdown",
  },
];
