  ...
  describe("Criteria-based Selection", () => {
      ...
      const itemContext = new Map([
        [
          101,
          {
            ...
            state: "Active",
            type: "Task",
            tags: ["Priority1", "Security"],
          },
        ],
        [102, { id: 102, title: "Item 2", state: "New", type: "Task", tags: ["Priority2"] }],
        [
          103,
          { id: 103, title: "Item 3", state: "Active", type: "Bug", tags: ["Security", "Bug"] },
        ],
    ...
    it("should filter by multiple tags", () => {
      ...
      const itemContext = new Map([
        ...
        [
          104,
          { id: 104, title: "Item 4", state: "Active", type: "Task", tags: ["Critical", "Bug"] },
        ],
      ]);
      ...
      const itemContext = new Map([
        [
          101,
          {
            ...
            state: "Active",
            type: "Task",
            tags: ["High Priority", "Security-Critical"],
          },
        ],
        ...
        [
          103,
          {
            ...
            state: "Active",
            type: "Bug",
            tags: ["Security-Critical", "Bug Fix"],
          },
        ],
      ]);
      ...
      const itemContext = new Map(
        workItemIds.map((id) => [
          id,
          {
            ...
            tags:
              id % 5 === 0 ? ["Critical", "Security"] : id % 7 === 0 ? ["Performance"] : ["Normal"],
            daysInactive: id % 100,
          },
        ])
      );
