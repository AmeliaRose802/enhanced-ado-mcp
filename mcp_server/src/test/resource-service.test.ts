...
import { listResources, getResourceContent, resourceExists } from "../services/resource-service";
...
describe("Resource Service", () => {
  ...
  describe("getResourceContent", () => {
    it("should throw error for non-existent resource", async () => {
      await expect(getResourceContent("ado://docs/non-existent")).rejects.toThrow(
        "Resource not found"
      );
    });
