    ...
    async sendRequest(method: string, params: any = {}): Promise<string> {
        ...
        return new Promise((resolve, reject) => {
            ...
            const dataHandler = (data: Buffer) => {
                ...
                if (output.includes('"result"') || output.includes('"error"') || output.includes('Tools:') || output.includes('Prompts:')) {
...
async function runStressTests() {
    ...
    try {
        ...
        try {
            ...
            console.log('❌ Rapid fire test failed:', error instanceof Error ? error.message : String(error));
        }
        ...
        try {
            ...
            console.log('❌ Large payload test failed:', error instanceof Error ? error.message : String(error));
        }
        ...
        try {
            ...
            console.log('❌ Invalid JSON test failed:', error instanceof Error ? error.message : String(error));
        }
        ...
        try {
            ...
            console.log('❌ Sequential calls test failed:', error instanceof Error ? error.message : String(error));
        }
        ...
        try {
            ...
            console.log('❌ Failed to handle null arguments:', error instanceof Error ? error.message : String(error));
        }
        ...
        try {
            ...
            console.log('❌ Unicode test failed:', error instanceof Error ? error.message : String(error));
        }

    } catch (error) {
        console.error('❌ Stress test setup failed:', error instanceof Error ? error.message : String(error));
    } finally {
        tester.stopServer();
    }
