...
describe("OData Analytics Handler - includeOdataMetadata parameter", () => {
  ...
  describe("when includeOdataMetadata is false (default)", () => {
    it("should strip @odata.* fields from results and top-level response", async () => {
      const mockResponse = {
        "@odata.context":
          "https://analytics.dev.azure.com/test-org/test-project/_odata/v4.0-preview/$metadata#WorkItems",
        "@odata.count": 2,
        value: [
          {
            "@odata.id":
              "https://analytics.dev.azure.com/test-org/test-project/_odata/v4.0-preview/WorkItems(123)",
            WorkItemId: 123,
            State: "Active",
            Count: 5,
          },
          {
            "@odata.id":
              "https://analytics.dev.azure.com/test-org/test-project/_odata/v4.0-preview/WorkItems(456)",
            WorkItemId: 456,
            State: "Closed",
            Count: 3,
          },
    ...
    it("should strip @odata.nextLink when present", async () => {
      const mockResponse = {
        ...
        "@odata.count": 100,
        "@odata.nextLink":
          "https://analytics.dev.azure.com/test-org/test-project/_odata/v4.0-preview/WorkItems?$skip=50",
        value: [
          {
            "@odata.id":
              "https://analytics.dev.azure.com/test-org/test-project/_odata/v4.0-preview/WorkItems(123)",
