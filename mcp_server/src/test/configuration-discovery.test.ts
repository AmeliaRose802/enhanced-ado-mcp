...
async function testConfigurationTools() {
  ...
  try {
    ...
    console.log(
      "💡 Note: Discovery tools require Azure CLI login (az login) to access live Azure DevOps data."
    );
    console.log(
      "📋 The configuration tools provide all the needed defaults and guidance for agents."
    );
  } catch (error) {
