...
```json
// Tool: query-wiql (with description for AI generation)
{
...
```json
// Tool: query-odata (with description for AI generation)
{
...
```json
// Tool: query-odata (with predefined query)
{
...
```json
// Tool: create-workitem (repeat for each child)
{
...
```json
// Tool: analyze-workload-analyzer (for each candidate)
{
  "workItemId": 12345,
  "outputFormat": "json"
}
...
```json
// Tool: extract-security-links (for each security item)
{
  "workItemId": 12345
}
```
...
```json
// Tool: analyze-workload-analyzer
{
  "workItemId": 12345,
  "outputFormat": "json"
}
...
// Use link-workitems to create the links
```
