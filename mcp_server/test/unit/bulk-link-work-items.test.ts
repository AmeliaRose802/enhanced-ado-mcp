...
describe("Bulk Link Work Items Handler", () => {
  ...
  describe("Link strategies", () => {
    ...
    it("should create one-to-many links", async () => {
      ...
      const sourceContext = new Map([[101, { title: "Epic 1", state: "Active", type: "Epic" }]]);
      const targetContext = new Map(
  ...
  describe("Link types", () => {
    it("should support Parent link type", async () => {
      ...
      const sourceContext = new Map([[101, { title: "Task 1", state: "Active", type: "Task" }]]);
      const targetContext = new Map([
        [201, { title: "Feature 1", state: "Active", type: "Feature" }],
      ]);
    ...
    it("should support Child link type", async () => {
      ...
      const targetContext = new Map([[201, { title: "Task 1", state: "Active", type: "Task" }]]);
    ...
    it("should support Related link type", async () => {
      ...
      const sourceContext = new Map([[101, { title: "Bug 1", state: "Active", type: "Bug" }]]);
      const targetContext = new Map([[201, { title: "Bug 2", state: "Active", type: "Bug" }]]);
    ...
    it("should support dependency link types", async () => {
      ...
      const sourceContext = new Map([[101, { title: "Task 1", state: "Active", type: "Task" }]]);
      const targetContext = new Map([[201, { title: "Task 2", state: "Active", type: "Task" }]]);
