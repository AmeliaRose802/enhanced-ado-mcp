...
describe("Bulk Operations Integration Tests", () => {
      ...
      const workItemContext = new Map([
        [
          101,
          {
            ...
            state: "New",
            type: "Feature",
            iterationPath: "TestProject\\Backlog",
          },
        ],
        [102, { title: "Bug 1", state: "New", type: "Bug", iterationPath: "TestProject\\Backlog" }],
        [
          103,
          { title: "Task 1", state: "New", type: "Task", iterationPath: "TestProject\\Backlog" },
        ],
        [
          104,
          { title: "Task 2", state: "New", type: "Task", iterationPath: "TestProject\\Backlog" },
        ],
      ]);
  ...
  describe("Scenario 5: Selective Operations with Criteria", () => {
    it("should perform selective operations based on multiple criteria", async () => {
      ...
      const workItemContext = new Map([
        ...
        [
          704,
          { title: "Recent Task", state: "Active", type: "Task", tags: "feature", daysInactive: 2 },
        ],
        [
          705,
          { title: "Stale Bug", state: "Active", type: "Bug", tags: "normal", daysInactive: 60 },
        ],
        [
          706,
          { title: "New Feature", state: "New", type: "Task", tags: "feature", daysInactive: 0 },
        ],
      ]);
  ...
  describe("Scenario 6: Error Recovery and Partial Success", () => {
    it("should handle partial failures gracefully", async () => {
      ...
      expect(result.warnings).toEqual(expect.arrayContaining([expect.stringContaining("failed")]));
    });
  });
});
